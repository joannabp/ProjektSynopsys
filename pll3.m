...
function [clk_o,clk_out,clk1_out,t_vco,f_vco,curr_end_vco,v_int_num,kp,z,error]=pll3(clk_out,clk1_out,curr_end_vco,v_int_num,data,data_prev,slope_in,kp,z,t)
...
[v_int,v_int_num,kp,z]=integrate9(v_df,v_int_num,kp,1,z);
