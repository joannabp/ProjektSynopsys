...
function [clk_o,clk_out,clk1,t_vco,f_vco,curr_end_vco,v_int_num,kp,z,error]=pll3(clk_out,clk1,curr_end_vco,v_int_num,data,data_prev,slope_in,kp,z,zmax,ph_det_mode,t)
