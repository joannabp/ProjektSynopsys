...
function [clk_o,clk_out,clk1_out,t_vco,f_vco,curr_end_vco,v_int_num,v_df,error]=pll3(clk_out,clk1_out,curr_end_vco,v_int_num,data,data_prev,slope_in,v_df,t)%clk,clk_ideal,curr,curr_sl,curr_end,curr_end_tot,clk_out,clk1_out,curr_vco,curr_end_vco,time,v_int_num,t,slope_in_prev,slope_out_prev,t_clk,f_clk,data,slope_sampled)
...
if(t>1)
    ...
    v_df=phase_detector10(data,data_prev,slope_in,v_df);
end
