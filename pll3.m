...
function [clk_o,clk_out,clk1_out,t_vco,f_vco,curr_vco,curr_end_vco,v_int_num,error]=pll3(clk_out,clk1_out,curr_vco,curr_end_vco,v_int_num,data,data_prev,slope_in,t)%clk,clk_ideal,curr,curr_sl,curr_end,curr_end_tot,clk_out,clk1_out,curr_vco,curr_end_vco,time,v_int_num,t,slope_in_prev,slope_out_prev,t_clk,f_clk,data,slope_sampled)
...
if(t>1)
    ...
    [data, slope, min_eye300_100_tmp, min_eye100_100_tmp, min_eye100_300_tmp,setup_200_tmp, setup0_tmp, setup200_tmp, hold_200_tmp, hold0_tmp, hold200_tmp, eyeO1_tmp, eyeO2_tmp, eyeO3_tmp, wf, th200, scaled_th_dat]=data_recovery(input_vector(i:i+74), 
end
