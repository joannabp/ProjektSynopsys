...
dlugosc_kanalu = 10;
input_bytes=12000;   % number of input bytes
...
%---------------------Driver----------------------------------------------%
[clk,t_clk,f_clk,~,~]=clk_gen_f_not_id5(1.02*freq,0,vector_length,0,vector_length2,1);
...
%eq_dat=ctle(channel_data, 2e9, 12); % (signal, fz, gain)
...
save('pulses_12kB_10_2G_all.mat');
