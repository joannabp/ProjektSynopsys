...
%     eyeO3(t)=eyeO3_tmp;
    ...
    if(j>1)
        [clk_o,clk_out,clk1_out,t_vcos(j+delay),f_vcos(j+delay),curr_end_vco,v_int_num(j),error_pll]=pll3(clk_out,clk1_out,curr_end_vco,v_int_num(j-1),data,out_data(j-1),slope,j);
    else
