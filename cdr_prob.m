...
function  [out_data, slope_sampled,setup_200, setup0, setup200, hold_200, hold0, hold200, wf,clk_o,clk_o2,clk1,f_vco_end,v_int_end,kp_end,f_vcos,setupt,holdt,v_int_num,kps,data_curr, th_200_all, th200_all, th0_all]=cdr_prob(input_vector,clk_start,clk_start2,clk1,f_vco_start,v_int_start,kp_start,stage)
...
th_200_all=zeros(1,input_bits);
th200_all=zeros(1,input_bits);
th0_all=zeros(1,input_bits);
...
while ((i<length(input_vector)-100) &&end_pll==0)%&&j<50)
    ...
    [data, ~, setup_200_tmp, setup0_tmp, setup200_tmp, hold_200_tmp, hold0_tmp, hold200_tmp, wf, th200_k, scaled_th_dat, sample, th_200, th0, th200]=data_recovery(input_vector(i:i+t_clks(j)), clk(i:i+t_clks(j)), clk(i:i+t_clks(j)), wf, th200_k, scaled_th_dat, sample);
    th_200_all(j)=th_200(1);
    th200_all(j)=th200(1);
    th0_all(j)=th0(1);
